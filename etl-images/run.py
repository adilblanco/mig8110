...
def main(
    ...
    if command == "extract_data":
        ...
        transform_data(
            ...
            products_output_file_key=products_output_file_key,
            ingredients_output_file_key=ingredients_output_file_key,
            product_ingredients_output_file_key=product_ingredients_output_file_key,
        )
        ...
        raise click.ClickException(f"Unsupported command: {command}")
