...
FILTER_COLUMNS = ",".join([
    ...
    "ecoscore_score", "ecoscore_grade", "images", "ingredients_tags","ingredients_original_tags", "ingredients",
    "ingredients_analysis_tags","ingredients_percent_analysis","ingredients_from_palm_oil_n","ingredients_n",
